    ...
    return (
        <div className="relative w-full h-[450px] rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-lg bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            ...
            <div className="absolute top-4 left-4 z-[1000]">
                <div className="bg-white/95 backdrop-blur shadow-md border border-slate-100 p-2 rounded-xl">
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Live Feed</p>
                    <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500 animate-pulse" />
                        <span className="text-xs font-bold text-slate-800">{junction?.name || "Initializing..."}</span>
                    </div>
                </div>
            </div>
